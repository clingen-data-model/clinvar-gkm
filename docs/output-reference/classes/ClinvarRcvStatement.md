...
| `extensions` | `Extension`[] (unordered) | 0..m | Aggregate-level extensions. See [RCV Statements — Extensions](../rcv-statements.md#extensions) for the complete list of extension names, value types, and descriptions. |
