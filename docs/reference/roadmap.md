...
| 6 | **Aggregate & case-level observations support** — include ClinVar observation data (currently Planned) | Proposed | [#104](https://github.com/clingen-data-model/clinvar-gkm/discussions/104) |
